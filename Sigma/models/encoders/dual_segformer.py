...
class RGBXTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 ...
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], extra_in_chans=3):
        super().__init__()
        self.num_classes = num_classes
        self.depths = depths
        self.extra_in_chans = extra_in_chans  # Configurable: 1 for UAVScenes HAG, 2 for DELIVER LiDAR
        ...
        # Extra modality patch embed - uses extra_in_chans for configurable input
        self.extra_patch_embed1 = OverlapPatchEmbed(img_size=img_size, patch_size=7, stride=4, in_chans=extra_in_chans,
                                              embed_dim=embed_dims[0])
        print(f"[Sigma] Extra modality input channels: {extra_in_chans}")
