...
class MulMamba(nn.Module):
    def __init__(self,
                 ...
                 patch_size=4,
                 in_chans=3,
                 extra_in_chans=3,  # Configurable: 1 for UAVScenes HAG, 2 for DELIVER LiDAR
                 num_classes=1000,
                 depths=[2, 2, 8, 2],
                 dims=96,
                 # ===================
        ...
        print(f"[MulMamba] Extra modality input channels: {extra_in_chans}")
        ...
        # extra path embed - uses extra_in_chans for configurable input
        self.extra_path_embed = nn.ModuleList([_make_patch_embed(extra_in_chans, dims[0], patch_size, patch_norm, norm_layer,
